...
- **[Trust models](./sectorial-rulebook/trust-models/README.md)**: Outlines trust models accepted for **Education and Professional qualifications** (Classical PKI & Decentralised PKI using EBSI). 
...
- [Bridge between Classical PKI and dPKI using EBSI](./sectorial-rulebook/trust-models/README.md): How the trust models of classical PKI and dPKI are combined to enable and support the governance of education and professional qualifications
