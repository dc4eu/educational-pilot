...
As one of the pre-requisites for obtaining a verifiable credential from the University it will be necesary to obtain a PID. This section describes how an student can obtain a PID.
