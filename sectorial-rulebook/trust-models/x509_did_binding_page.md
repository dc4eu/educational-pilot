# A Comprehensive Guide to Binding X.509v3 Certificates with Decentralised Identifiers anchored in EBSI for issuance of Electronic Attestations of Attributes
...
This guide addresses **Scenario 2**, where EBSI's DID infrastructure and Verifiable Accreditation model fill trust gaps by verifying the issuer's authorisation and attribute authenticity, whether it is an authentic source or a non-qualified TSP.
...
2. **Generate X.509v3 CSR**: Initiate a CSR to request a certificate
...
With this model, we decouple the credential signing certificate lifecycle from the organisation's accreditation lifecycle.
...
5. **Verify Issuer Trust Chain:**
   ...
   - Verify TSP accreditation via EBSI Verifiable Accreditation (e.g., authorised to issue degrees)
...
- **Verifiable Accreditation**: Confirming TSP authorisations
...
- Only one certificate can be bound to a single public key
...
This enables trusted EAA issuance, bridging decentralised and traditional trust models effectively.

For implementation of the verification side of this ecosystem, please refer to the [Wallet Relying Party PKI Guidelines](./wallet-relying-party-pki.md).

## References

- Regulation (EU) 2024/1183 (eIDAS Amendment)
- W3C Verifiable Credentials Data Model 1.1
- RFC 7638 - JSON Web Key (JWK) Thumbprint
- RFC 5280 - Internet X.509 Public Key Infrastructure
- ETSI standards for digital certificates
- EBSI Technical Specifications

---

*This document is part of the DC4EU project deliverables focusing on Scenario 2 implementation for enhanced trust in non-qualified Electronic Attestations of Attributes.*