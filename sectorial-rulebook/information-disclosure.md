...
- Educational example: Embeded disclosure policy could be defined for MyAcademicID EAA, so only edcuational insittutions wthi "License to act at European level" & "Higher Edcuation" auhtorisations being able to request/consume these type of EAAs.
...
- Educational example: Selective dislosure terms of reference could be defined for "Educational ID" EAA, so schacPersonalUniqueCode can't be disclaimed alone, being mandatory to be disclose togteher with schacHomeOrganization.
