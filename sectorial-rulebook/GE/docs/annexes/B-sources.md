...
The sources listed in this annex satisfy at least one of the following criteria:

1. They are Recommendations published by recognised standardisation bodies (W3C, ETSI, ISO, IETF, OpenID Foundation).
2. They are normative texts in force or normative proposals published by the European Commission, the Council or the Parliament.
3. They are official deliverables of projects funded by the European Commission with a traceable project number.
4. They are publications of consortia or associations representative of the sector whose technical authority is recognised (EBSI, DG EMPL, DG CONNECT, CRUE, EUNIS, 1EdTech, Credential Engine, Groningen Declaration Network).

Citations are grouped by family: EU normative texts, W3C Recommendations, ETSI specifications, OpenID and IETF specifications, ISO standards, DEP/EEA deliverables, institutional literature.

## B.2 European Union legislation
...
- **Council Recommendation of 16 June 2022** on a European approach to micro-credentials for lifelong learning and employability. OJEU C 243, 27.6.2022.
- **Resolution P10_TA(2026)0022** of the European Parliament on digital sovereignty and European identity architecture.
- **Ref. Ares(2026)1286304** — Public consultation of the Commission on the technical profile of the EUDIW (5 February to early March 2026).

## B.3 W3C Recommendations and Candidate Recommendations

- **W3C. Verifiable Credentials Data Model v1.1**. W3C Recommendation, 3 March 2022. https://www.w3.org/TR/vc-data-model/
- **W3C. Verifiable Credentials Data Model v2.0**. W3C Recommendation, 15 May 2025. https://www.w3.org/TR/vc-data-model-2.0/
- **W3C. Securing Verifiable Credentials using JOSE and COSE (VC-JOSE-COSE)**. W3C Recommendation, 15 May 2025. https://www.w3.org/TR/vc-jose-cose/
...
- **W3C VC Implementers (Community Group)**. Test suites and interop reports (continuously updated).
...
## B.5 OpenID Foundation and IETF specifications
...
- **HAIP (High Assurance Interoperability Profile)**. OpenID Foundation.
- **IETF SD-JWT VC** (draft-ietf-oauth-sd-jwt-vc). IETF OAuth WG.
- **IETF SD-JWT** (RFC candidate). IETF OAuth WG.
- **RFC 8949** — Concise Binary Object Representation (CBOR).
- **RFC 8610** — Concise Data Definition Language (CDDL).
- **RFC 7519** — JSON Web Token (JWT).
- **RFC 7515 / 7516 / 7517 / 7518** — JSON Object Signing and Encryption (JOSE).
...
- **DC4EU (Digital Credentials for Europe)**. Grant Agreement 101102718, Digital Europe Programme.
  - D5.1.1 — W3C-VCDM Justification for Education.
  - D5.1.2 — Sectoral EAA Catalogue.
  - D5.2 — Pilot deployment report.
  - Web: https://www.dc4eu.eu/
- **EBSI-VECTOR**. Large Scale Pilot, Digital Europe Programme.
- **TRACE4EU**. Large Scale Pilot, Digital Europe Programme.
- **PH4H (Pharmaceuticals for Health)**. Sectoral pilot.
- **Safe Island**. Sectoral pilot.
- **Catena-X**. Initiative for automotive data space.
- **Gaia-X**. European data infrastructure initiative.
- **EDCT (Europass Digital Credentials Transition)**. DG EMPL.
- **EBSI (European Blockchain Services Infrastructure)**. https://ec.europa.eu/digital-building-blocks/wikis/display/EBSI/

## B.8 European vocabularies and frameworks

- **ELM v3.2** — European Learning Model. DG EMPL. https://europass.europa.eu/
- **EDC v1.9** — European Digital Credentials for Learning.
- **EQF** — European Qualifications Framework. Recommendation 2017/C 189/03.
- **ESCO** — European Skills, Competences, Qualifications and Occupations. https://esco.ec.europa.eu/
- **ISCED-F** — UNESCO International Standard Classification of Education, Fields.
- **NACE Rev. 2** — Statistical classification of economic activities.
- **ELI** — European Legislation Identifier. http://data.europa.eu/eli/

## B.9 European public investment and initiatives

- **ALASTRIA**. Aggregate European public investment in W3C-VCDM > €80M.
...
- **Groningen Declaration Network**. Global network of student data exchange.

## B.10 Convergent global ecosystems

- **1EdTech Consortium**. Open Badges 3.0. https://www.1edtech.org/
...
- **European Commission, DG CONNECT**. ARF (Architecture and Reference Framework) for the European Digital Identity Wallet. Successive versions published between 2022 and 2026.
...
All the cited W3C Recommendations are publicly accessible at https://www.w3.org/TR/ without paywall, with stable canonical URIs. ETSI specifications are public and downloadable from https://www.etsi.org/standards. EU texts are accessible at https://eur-lex.europa.eu/. DC4EU deliverables are accessible on the project portal and, after the pilot's completion, will be transferred to the successor institutional repository designated by the Commission.
