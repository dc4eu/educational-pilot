...
The DC4EU Pilot2 scenarios demonstrate three distinctive approaches to implementing Hybrid Trust (Classical PKI + Decentralised PKI) digital credential systems across European educational institutions. Through 31 institutional scenarios across 10 countries, this pilot reveals **distributed autonomous deployments** (ATOS/IZERTIS Dockerised), **managed service implementations** (ATOS/IZERTIS SaaS via GovPart), and **coordinated national deployments** (OPI/NASK), providing educational institutions with multiple pathways to next-generation digital credentials whilst highlighting different governance, service delivery, and infrastructure strategies within the European decentralised identity ecosystem.

## Pilot2 Piloting Agent Scenarios

This analysis covers representative scenarios from the 31 participating institutions, highlighting the three primary implementation approaches:
...
- **[Edutus University](edutus_pilot2_scenario.md)** - Private Higher Education Institution

#### Italy (1 institution)
- **[University of Bologna](unibo_pilot2_scenario.md)** - Comprehensive Research University Implementation

#### Lithuania (2 institutions)
- **[Vytautas Magnus University](vdu_pilot2_scenario.md)** - Comprehensive University Implementation
- **[Skaitos kompiuterių servisas](sks_pilot2_scenario.md)** - IT Services and Professional Verification

#### Portugal (2 institutions)
- **[Universidade do Porto](up_pilot2_scenario.md)** - Leading Portuguese Research University
- **[University of Maia](umaia_pilot2_scenario.md)** - Applied Sciences Focus

#### Romania (3 institutions)
- **[Politehnica University of Timisoara](upt_pilot2_scenario.md)** - Technical University Implementation
- **[UEFISCDI](uefiscdi_pilot2_scenario.md)** - National Higher Education Authority
- **[Titu Maiorescu University](utm_pilot2_scenario.md)** - Private University Implementation

#### Spain (11 institutions)
- **[University of Alcalá](uah_pilot2_scenario.md)** - Comprehensive University Implementation
- **[University of Málaga](uma_pilot2_scenario.md)** - Research University with Professional Focus
- **[Universidad Carlos III de Madrid](uc3m_pilot2_scenario.md)** - Engineering and Technology Focus
- **[Universidad de Murcia](um_pilot2_scenario.md)** - Comprehensive University Implementation
- **[Universitat Rovira i Virgili](urv_pilot2_scenario.md)** - Research University Implementation
- **[CGCOM](cgcom_pilot2_scenario.md)** - Medical Professional Credential Integration
- **[Universidad Politécnica de Madrid](upm_pilot2_scenario.md)** - Technical University Implementation
- **[Universidad Española a Distancia (UNED - Dockerised)](uned_dockerised_pilot2_scenario.md)** - Distance Education Dockerised Implementation
- **[University of Alcalá - Medical Focus](uah_medical_pilot2_scenario.md)** - Medical Education Specialisation
- **[Regional Spanish University Consortium](spain_regional_pilot2_scenario.md)** - Multi-institutional Regional Implementation
- **[Spanish Technical Universities Network](spain_technical_pilot2_scenario.md)** - Technical Education Consortium

### ATOS/IZERTIS SaaS Model via GovPart (3 institutions)

#### Germany (2 institutions)
- **[Ludwig-Maximilians-Universität München (LMU)](lmu_pilot2_scenario.md)** - Leading Research University SaaS Implementation
- **[Humboldt-Universität zu Berlin (HU Berlin)](hub_pilot2_scenario.md)** - Research University SaaS Implementation
...
- **[University of Silesia (US)](us_pilot2_scenario.md)** - Comprehensive Educational Credential Management
- **[Silesian University of Technology (POLSL)](polsl_pilot2_scenario.md)** - Technical Education Integration
- **[Kozminski University](kozminski_pilot2_scenario.md)** - Business Education Focus
...
All implementation models achieved **100% deployment success** with critical technical milestones:
...
- **Implementation Gap**: Whilst basic embedded disclosure has been implemented in the hybrid approach (released 30 July), the complete SD-JWS selective disclosure with demonstrated jAdES compliance has not yet been deployed across all participating institutions
...
1. **Hybrid Trust Scalability**: All three models demonstrate technical feasibility at institutional, managed service, and national scales
2. **European Interoperability**: Universal EBSI integration enables seamless cross-border verification capabilities
3. **Standards Compliance**: W3C Verifiable Credentials implementation ensures international interoperability
4. **Flexible Service Models**: Multiple deployment approaches accommodate diverse institutional capabilities and preferences

### Scaling Pathway

1. **Deployment Model Selection**: Institutions can choose optimal approach based on technical capabilities and strategic objectives
2. **Professional Support Options**: Multiple support models ensure appropriate assistance regardless of chosen deployment approach
3. **European Integration**: All models maintain full European interoperability through EBSI integration
...
The successful demonstration of three distinct but equally viable deployment models within Pilot2 validates the **adaptability required for pan-European adoption** whilst ensuring **technical standardisation** for seamless cross-border credential recognition.

All models successfully overcome the classical PKI limitations identified in Pilot1, providing:
...
All implementation models successfully demonstrate **next-generation capabilities** unavailable in classical PKI:
