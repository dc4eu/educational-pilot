# DC4EU Deployment and Testing Scenarios Results Library (DTSRL) – Scenario: University of Zielona Gora (ZGORA)

## 1. Scenario Identification

* **Piloting agent name**: University of Zielona Gora (ZGORA)
...
* **Institutional systems/databases connected**:
  ZGORA authentic source databases (academic records), identity verification system, student information system
...
* **Governance configuration**:
  ...
  * **Issuer DID**:
    ...
    ```
    did:ebsi:z23FZjMPSLsWZ1EZB3CNn1ni
    ```
  * **Verifier DID**:
  ...
  * **Issuer public key reference (PKI)**:
    ...
    ```
    Subject CN: u6.pilot-dc4eu.ebsi.nask.pl
    Organization: University of Zielona Gora
    Country: PL
...
* **Issuer public key reference (PKI)**:
  ```
  -----BEGIN CERTIFICATE-----
  [PKI Certificate for u6.pilot-dc4eu.ebsi.nask.pl - 3 certificate chain]
  Subject: C=PL, O=University of Zielona Gora, CN=u6.pilot-dc4eu.ebsi.nask.pl
...
* **Screenshots or logs**: Available in DC4EU workspace: Poland-ZGORA folder
* **Credential samples**: EducationalID and University degree samples (redacted) available for review
* **Links to shared environment/demo**: https://u6.pilot-dc4eu.ebsi.nask.pl (DNS endpoint operational)
* **Documents or repositories**: ZGORA scenario characterisation documents, OPI/NASK SaaS integration specifications
