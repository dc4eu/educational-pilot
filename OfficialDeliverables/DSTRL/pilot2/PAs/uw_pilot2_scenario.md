# DC4EU Deployment and Testing Scenarios Results Library (DTSRL) – Scenario: University of Warsaw (UW)

## 1. Scenario Identification

* **Piloting agent name**: University of Warsaw (UW)
...
* **Point of contact (SPOC)**: Krzysztof Cieślikowski (OPI)
...
* **Institutional systems/databases connected**:
  UW authentic source databases (academic records), identity verification system, student information system
...
* **Governance configuration**:
  ...
  * **Issuer DID**:
    ...
    ```
    did:ebsi:z25xR4nPxiMXndnZ2wJVf2hd
    ```
  * **Verifier DID**:
  ...
  * **Issuer public key reference (PKI)**:
    ...
    ```
    Subject CN: u1.pilot-dc4eu.ebsi.nask.pl
...
* **Issue escalation**:
  ...
  * SPOC contact: Krzysztof Cieślikowski (OPI)
...
* **Issuer public key reference (PKI)**:
  ...
  ```
  -----BEGIN CERTIFICATE-----
  [PKI Certificate for u1.pilot-dc4eu.ebsi.nask.pl - 3 certificate chain]
  Subject: C=PL, O=University of Warsaw, CN=u1.pilot-dc4eu.ebsi.nask.pl
...
* **Registry references**:
  EBSI Trust Registry entries (registered), Polish Sectorial EAA Catalogue
* **PID credentials used**:
  Polish national eIDAS 2.0 compliant PID credentials
* **Proof of wallet compatibility tests**:
  Integration testing completed with OPI/NASK SaaS solution
...
* **Successes**:
  Successful PKI certificate deployment, OPI/NASK SaaS integration completed, EBSI DID registration completed (did:ebsi:z25xR4nPxiMXndnZ2wJVf2hd), PID retrieval user journey executed successfully, comprehensive educational credential issuance and verification workflows demonstrated, effective integration with Polish national infrastructure
* **Issues encountered**:
  Minor initial configuration requirements for Polish regulatory context, successfully resolved
* **Deviation from plan**:
  No significant deviations, implementation proceeded as planned with successful completion via OPI/NASK SaaS
...
* **What worked as expected**:
  ...
  * National infrastructure integration successful
...
* **Feedback from users**:
  Positive response from university students, appreciation for digital credential innovation and potential for academic mobility within Poland and Europe
* **Impact on user experience and feasibility**:
  Demonstrates successful feasibility of hybrid trust model approach for Polish university context using national SaaS infrastructure. Strong potential demonstrated for enhancing student mobility and credential recognition.
...
* **Screenshots or logs**:
  Available in DC4EU workspace: Poland-UW folder
* **Credential samples**:
  EducationalID and University degree samples (redacted) available for review
* **Links to shared environment/demo**:
  https://u1.pilot-dc4eu.ebsi.nask.pl (DNS endpoint operational)
* **Documents or repositories**:
  UW scenario characterisation documents, OPI/NASK SaaS integration specifications
...
* **Pending actions**:
  ...
  * Documentation of lessons learned for other Polish universities
...
* **Recommendations for future pilots or replication**:
  * OPI/NASK SaaS solution provides effective national implementation pathway
  * Early integration with Polish governance frameworks
  * Standardise Polish university credential formats
  * Implement comprehensive training programmes for Polish university contexts
...
* Suggestions for improvement:
  Request for additional credential types, interest in enhanced Polish language support
...
* Feedback on support received:
  Excellent support from OPI/NASK technical team, effective national SaaS solution deployment
* Main barriers during implementation:
  Polish regulatory context integration, minor technical optimisation requirements
* Lessons learned:
  Value of national SaaS solution for rapid deployment, importance of Polish regulatory alignment, effectiveness of OPI/NASK platform
* Observed impact and value:
  Demonstrates significant potential for transforming Polish higher education credential management
* Recommendations for scaling:
  * Expand OPI/NASK SaaS solution to other Polish universities
  * Standardise Polish university credential formats
  * Develop comprehensive training materials for Polish university adoption
  * Create clear integration pathways for Polish higher education institutions