...
- **Android**: [Google Play Store](https://play.google.com/store/apps/details?id=com.identfydc4eu.app) v1.3.6 (build 14)
- **iOS**: [TestFlight](https://testflight.apple.com/join/Z7WhgfKC) v1.3.6 (build 14)
