...
| Academic and professional achievements       | Europass EDC credential  | Europass-compliant credential format based on ELM v3.2, supports Diploma and Certificate Supplements | [Schema](https://code.europa.eu/ebsi/json-schema/-/tree/main/schemas/vcdm1.1/europass/edc)                        | [Registry](https://api-pilot.ebsi.eu/trusted-schemas-registry/v3/schemas/z5P8ebAhZjuvypiSXSHoba6vstbhTwnLhVuULWKenuiNJ) |
