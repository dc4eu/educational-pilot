...
| Non-foundational identity   | ProfessionalID             | Identity credential for , based on  |[LocalSchema](./non-foundational-id/professionalID-schema.md)| [Local shcema Schema](../sectorial-eaa-catalogue/non-foundational-id/Professional%20ID%20Schema.md)     | [Registry](https://api-pilot.ebsi.eu/trusted-schemas-registry/v3/schemas/z3XDm4kDtztE8DzLsVdhfshYvx2upnfLmqHtyVjkaXM1g) |
