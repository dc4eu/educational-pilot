...
## Higher education proof of enrolment (`HEPOE`)

```json
{
  "eaa_id": "HEPOE",
  "title": "Higher education proof of enrolment",
  "description": "Credential representing higher education proof of enrolment issued by an authorised institution under a recognised qualification framework.",
  "credential_type": "VerifiableAttestation",
  "data_model": {
    "standard": "W3C Verifiable Credentials",
    "profile": "DC4EU-Education",
    "schema_uri": "https://tsr.dc4eu.eu/schemas/hepoe.jsonld"
  },
  ...
  "issuable_by": {
    ...
    "taor_required": true,
    "tir_entry": "did:ebsi:issuer-hepoe"
  },
  "usable_by": {
  ...
  "presentation_policy_uri": "https://tsr.dc4eu.eu/policies/TO_BE_DEFINED-presentation-policy.json",
    "restricted_access": true,
    "verifier_role_check": true,
    "machine_readable": "https://tsr.dc4eu.eu/policies/hepoe-disclosure.json"
  },
  "terms_of_reference_uri": "https://tsr.dc4eu.eu/tor/hepoe.json",
  "revocation_support": {
    "method": "StatusList2021",
    "status_endpoint": "https://status.dc4eu.eu/status/hepoe",
