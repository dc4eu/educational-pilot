...
## Upper secondary education certificate (`USC`)

```json
{
  "eaa_id": "USC",
  "title": "Upper secondary education certificate",
  "description": "Credential representing upper secondary education certificate issued by an authorised institution under a recognised qualification framework.",
  "credential_type": "VerifiableAttestation",
  "data_model": {
    "standard": "W3C Verifiable Credentials",
    "profile": "DC4EU-Education",
    "schema_uri": "https://tsr.dc4eu.eu/schemas/usc.jsonld"
  },
  ...
  "presentation_policy_uri": "https://tsr.dc4eu.eu/policies/TO_BE_DEFINED-presentation-policy.json",
    "restricted_access": true,
    "verifier_role_check": true,
    "machine_readable": "https://tsr.dc4eu.eu/policies/usc-disclosure.json"
  },
  "terms_of_reference_uri": "https://tsr.dc4eu.eu/tor/usc.json",
  "revocation_support": {
    "method": "StatusList2021",
    "status_endpoint": "https://status.dc4eu.eu/status/usc",
