...
```json
{
  ...
  "description": "Foundational identifier for natural persons, required to associate any educational or professional EAA to a unique legal identity.",
  "credential_type": "QEAA",
  "data_model": {
    "standard": "W3C Verifiable Credentials",
    "profile": "DC4EU-FoundationalID",
    "schema_uri": "https://tsr.dc4eu.eu/schemas/pid-v1.jsonld"
  },
