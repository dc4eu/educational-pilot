# EUHEMC Unsigned Credential:
The unsigned_credential field in the artifact contains the full JSON-LD representation of the European Higher Education Microcredential (EUHEMC) without a signature. This is the payload that would be signed using the JAdES D-Zero profile.
